*Note*: this README file and accompanying data set were accessed by Phil Chodrow on Friday, Feb. 19th 2021 at https://www1.ncdc.noaa.gov/pub/data/ghcn/v4/ . The qcf data set is the one used. 
