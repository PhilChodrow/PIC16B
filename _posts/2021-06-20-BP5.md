...
Please make sure that you are able to consistently achieve **at least** 52% validation accuracy in this part. 
...
3. Models 1, 2, 3, and 4 are logically constructed and obtain the required validation accuracy in each case:
    ...
    - Model 2 should obtain at least 52% validation accuracy. 
